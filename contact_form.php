  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light text-uppercase fs-6 p-3 border-bottom align-items-center">
    <div class="container-fluid">
      <div class="row justify-content-between w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand" href="#.html"><img src="images/logo.svg" width="100" height="45" alt="logo"></a>
        </div>
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                    <li>
                      <a href="#.html" class="dropdown-item item-anchor">Home Layout 1</a>
                    </li>
                    <li>
        ...
        <div class="row">
          <div class="text-center">
            <div class="breadcrumbs">
              <span class="item"><a href="#.html">Home /</a></span>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
                <a href="#.html" class="item-anchor">Home</a>
              </li>
              <li class="menu-item">
